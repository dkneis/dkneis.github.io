...
The source code is managed in [this github repository](https://github.com/dkneis/rodeo). The current main documentation is the [package vignette](https://github.com/dkneis/rodeo/blob/master/vignettes/rodeo.pdf) (please save the PDF file to disk if it doesn't show up in the browser).
...
There is a collection of examples to demonstrate the functionality of `rodeo`. To try out the examples, you need a recent version of [`R`](https://www.r-project.org/) including the developer tools to compile Fortran code. I prepared a short PDF document with [minimalistic instructions](rodeoExamples/installShort.pdf). In case of problems, please consult the official [administration and installation guide](https://cran.r-project.org/doc/manuals/r-release/R-admin.html), especially the appendices.
